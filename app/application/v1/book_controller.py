...
from app.application.v1.schemas import BookCreate, BookRead
from app.application.v1.book_service import BookService
...
@books_router_v1.post("/books", response_model=BookRead, status_code=status.HTTP_201_CREATED)
...
@books_router_v1.put("/books/{book_id}", response_model=BookRead)
...
@books_router_v1.delete("/books/{book_id}", status_code=status.HTTP_204_NO_CONTENT)
